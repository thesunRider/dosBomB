...
proc vTclWindow.top44 {base} {
    ...
    wm geometry $top 604x375+847+224
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    label $site_4_0.lab61 \
        -background $vTcl(actual_gui_bg) -disabledforeground #a3a3a3 \
        -font TkDefaultFont -foreground $vTcl(actual_gui_fg) -text placerad 
    ...
    place $site_4_0.tLa62 \
        -in $site_4_0 -x 0 -relx 0.482 -y 0 -rely 0.088 -width 0 \
        -relwidth 0.152 -height 0 -relheight 0.106 -anchor nw \
        -bordermode ignore 
    place $site_4_0.tex63 \
        -in $site_4_0 -x 0 -relx 0.5 -y 0 -rely 0.22 -width 0 -relwidth 0.471 \
    ...
    frame $top.pNo47.t2 \
        -background $vTcl(actual_gui_bg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black 
    vTcl:DefineAlias "$top.pNo47.t2" "PNotebook1_t3" vTcl:WidgetProc "Toplevel1" 1
    ...
    frame $site_4_2.pNo45.t0 \
        -background $vTcl(actual_gui_bg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black 
    vTcl:DefineAlias "$site_4_2.pNo45.t0" "PNotebook2_t1" vTcl:WidgetProc "Toplevel1" 1
    ...
    frame $site_4_2.pNo45.t2 \
        -background $vTcl(actual_gui_bg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black 
    vTcl:DefineAlias "$site_4_2.pNo45.t2" "PNotebook2_t3" vTcl:WidgetProc "Toplevel1" 1
    ...
    frame $site_4_2.pNo45.t1 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black 
    vTcl:DefineAlias "$site_4_2.pNo45.t1" "PNotebook2_t2" vTcl:WidgetProc "Toplevel1" 1
    ...
    frame $site_4_2.pNo45.t3 \
        -background $vTcl(actual_gui_bg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black 
    vTcl:DefineAlias "$site_4_2.pNo45.t3" "PNotebook2_t4" vTcl:WidgetProc "Toplevel1" 1
    ...
    frame $site_4_2.pNo45.t4 \
        -background $vTcl(actual_gui_bg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black 
    vTcl:DefineAlias "$site_4_2.pNo45.t4" "PNotebook2_t5" vTcl:WidgetProc "Toplevel1" 1
    ...
    frame $site_4_2.pNo45.t5 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black 
    vTcl:DefineAlias "$site_4_2.pNo45.t5" "PNotebook2_t6" vTcl:WidgetProc "Toplevel1" 1
    ...
    frame $top.pNo47.t3 \
        -background $vTcl(actual_gui_bg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black 
    vTcl:DefineAlias "$top.pNo47.t3" "PNotebook1_t4" vTcl:WidgetProc "Toplevel1" 1
    ...
    label $site_4_3.lab57 \
        -background $vTcl(actual_gui_bg) -disabledforeground #a3a3a3 \
        -font TkDefaultFont -foreground $vTcl(actual_gui_fg) -text {dai dai} 
