...
#  Aug 27, 2020 11:05:06 PM IST  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top44 {base} {
    ...
    wm geometry $top 604x425+709+245
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    label $site_4_1.lab53 \
        -background $vTcl(actual_gui_bg) -disabledforeground #a3a3a3 \
        -font TkDefaultFont -foreground $vTcl(actual_gui_fg) -text trv 
    ...
    place $site_4_1.but51 \
        -in $site_4_1 -x 0 -relx 0.071 -y 0 -rely 0.229 -width 83 -relwidth 0 \
        -height 33 -relheight 0 -anchor nw -bordermode ignore 
