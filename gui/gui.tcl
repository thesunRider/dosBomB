...
#  Aug 21, 2020 09:09:44 PM IST  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top44 {base} {
    ...
    wm geometry $top 604x400+800+223
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    vTcl::widgets::ttk::pnotebook::createCmd $site_4_2.pNo45 \
        -width 540 -height 224 -takefocus {} -style "PC.TNotebook" 
    ...
    ttk::frame $top.tFr47 \
        -borderwidth 2 -relief groove -width 355 -height 25 
    vTcl:DefineAlias "$top.tFr47" "TFrame1" vTcl:WidgetProc "Toplevel1" 1
    ttk::style configure TFrame -background $vTcl(actual_gui_bg)
    ttk::frame $top.tFr48 \
        -borderwidth 2 -relief groove -width 255 -height 25 
    ...
    place $top.tFr47 \
        -in $top -x 0 -y 0 -rely 0.94 -width 0 -relwidth 0.588 -height 0 \
        -relheight 0.063 -anchor nw -bordermode ignore 
    place $top.tFr48 \
        -in $top -x 0 -relx 0.579 -y 0 -rely 0.94 -width 0 -relwidth 0.422 \
