...
#  Aug 14, 2020 12:28:32 AM IST  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top44 {base} {
    ...
    wm geometry $top 604x450+462+186
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    vTcl::widgets::ttk::pnotebook::createCmd $top.pNo47 \
        -width 554 -height 321 -takefocus {} -style "PC.TNotebook" 
    ...
    $top.pNo47 add $top.pNo47.t1 \
        -padding 0 -sticky nsew -state normal -text Main -image image2 \
    ...
    ###################
    place $top.fra45 \
        -in $top -x 0 -relx 0.017 -y 0 -rely 0.021 -width 0 -relwidth 0.959 \
        -height 0 -relheight 0.167 -anchor nw -bordermode ignore 
    place $top.pNo47 \
        -in $top -x 0 -relx 0.033 -y 0 -rely 0.222 -width 0 -relwidth 0.917 \
